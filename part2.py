...
#programming Principles 01 - Part two(Staff Version)
print("*"*51)
...
while option != 'q': #while is used here to loop the programme programme till the user enters the 'q'
    try:
        ...
        credits_checking(passCredits,deferCredits,failCredits) #Calling the function oneTwenty
        total_checking(passCredits,deferCredits,failCredits)#Calling the function credits_checking
        oneTwenty(passCredits,deferCredits,failCredits) #Calling the function total_checking
        ...
        print("_"*50)
print("Progress :",progressnum,progress) #displaying the number of progressed students and as printed stars
